...
export async function sendNotificationEmail(userEmail: string, userName: string) {
  try {
    ...
    const mailOptions = {
      ...
      to: userEmail,
      subject: 'Welcome to BookAdZone - We\'re Launching Soon!',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:600px; background-color:#080411; border-radius:16px;">
              ...
              <tr>
                <td style="background-color:#0a0718; border:1px solid #98a9b882; border-radius:12px; padding:25px 20px;">
                  <p style="font-size:16px; font-weight:600; color:#FFFFFF; margin-bottom:15px;">Hello ${userName},</p>
              ...
              <tr>
                <td align="center" style="padding:30px 20px;">
                  <a href="https://www.bookadzone.com" style="display:inline-block; background-color:#7F6AF7; color:#FFFFFF; text-decoration:none; padding:12px 32px; border-radius:30px; font-size:14px; font-weight:600;">
              ...
              <tr>
                <td align="center" style="background-color:#ffffff1f; padding:15px 10px;">
                  <p style="font-size:12px; color:#98A9B8; margin:0;">
                    Join our growing community of advertisers and agencies
                  </p>
                </td>
              </tr>
              ...
              <tr>
                <td align="center" style="border-top:1px solid #98a9b882; padding:30px 20px;">
                  <table cellspacing="0" cellpadding="0" border="0">
                    <tr>
                      <td align="center" style="padding:0 5px;">
                        <a href="https://facebook.com/bookadzone" style="display:inline-block; background-color:#7F6AF7; width:36px; height:36px; border-radius:50%; text-align:center;">
                      ...
                      <td align="center" style="padding:0 5px;">
                        <a href="https://twitter.com/bookadzone" style="display:inline-block; background-color:#7F6AF7; width:36px; height:36px; border-radius:50%; text-align:center;">
                      ...
                      <td align="center" style="padding:0 5px;">
                        <a href="https://instagram.com/bookadzone" style="display:inline-block; background-color:#7F6AF7; width:36px; height:36px; border-radius:50%; text-align:center;">
                      ...
                      <td align="center" style="padding:0 5px;">
                        <a href="https://linkedin.com/company/bookadzone" style="display:inline-block; background-color:#7F6AF7; width:36px; height:36px; border-radius:50%; text-align:center;">
                  ...
                  <p style="margin:20px 0 10px; color:#98A9B8; font-size:12px;">
                    <a href="https://www.bookadzone.com" style="color:#98A9B8; text-decoration:none; margin:0 5px;">Home</a> •
                    <a href="https://www.bookadzone.com" style="color:#98A9B8; text-decoration:none; margin:0 5px;">Features</a> •
                    <a href="https://www.bookadzone.com" style="color:#98A9B8; text-decoration:none; margin:0 5px;">How It Works</a> •
                    <a href="https://www.bookadzone.com" style="color:#98A9B8; text-decoration:none; margin:0 5px;">FAQ</a> •
